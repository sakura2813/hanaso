...
4. 過去のチャット履歴は「スレッド一覧」から確認可能

---

## アプリケーションを作成した背景
30代共働きで子育て中の親をターゲットに、育児の孤立感や医療アクセスの不安を軽減するために作成しました。  
日常のちょっとした体調の変化や育児の悩みを、病院に行かずにまず相談できる窓口を作りたいという思いから開発しています。  
...
## 実装予定の機能
- 症状チェック機能
  ユーザーが入力した気になる症状から、考えられる病気の可能性や受診の緊急度を自動判定
- 医療コラム配信機能
  季節ごとの流行疾患や、子育てに役立つ医療・健康情報を定期的に提供
- 医療機関検索連携機能
  現在地や条件をもとに、近隣の小児科や夜間診療可能な医療機関を検索可能
